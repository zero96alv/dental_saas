...
from .views import (
    ...
    PagoListView, PagoUpdateView, PagoDeleteView,
    ...
    #AgendaView, CitaListView, CitasPendientesPagoListView, FinalizarCitaView, ProcesarPagoView, ReciboPagoView,
    AgendaView, CitaListView, CitasPendientesPagoListView, FinalizarCitaView, ReciboPagoView,
